  ...
  const StudentLogin = () => {
    ...
    const handleStudentStart = async (e) => {
      ...
      try {
        ...
        // Menyimpan data tingkat ke database live
        await set(newStudentRef, { 
            name, class: kelas, token, mapel: validSession.mapel, tingkat: validSession.tingkat, status: 'online', progress: 0, warnings: 0, timestamp: Date.now() 
        });
